...
All 28 conditional-move variants follow `move_if_<condition>` — e.g. `move_if_equal`, `move_if_less`, `move_if_not_carry`. See [docs/syntax.md](docs/syntax) for the complete table.
